...
if __name__ == "__main__":
    ...
    training_data_origin, test_data_origin = data_origin.data_cut(10, 9)
    training_data_MinMax, test_data_MinMax = data_MinMax.data_cut(10, 9)
    training_data_Mean, test_data_Mean = data_Mean.data_cut(10, 9)
    training_data_Standardization, test_data_Standardization = data_Standardization.data_cut(10, 9)
    ...
    trainer_MinMax.test(theta_MinMax)
    trainer_Mean.test(thetaMean)
    trainer_Standardization.test(theta_Standardization)
